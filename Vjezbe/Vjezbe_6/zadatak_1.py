...
x = [0.3*np.sin(np.sqrt(10/0.1)*i + np.arctan(0.3*np.sqrt(10/0.1)/0)) for i in vrijeme]
plt.subplot(1,3,1)
plt.plot(vrijeme, x, linewidth = 1)

v = [np.sqrt(10/0.1)*0.3*np.cos(np.sqrt(10/0.1)*i + np.arctan(0.3*np.sqrt(10/0.1)/0)) for i in vrijeme]
plt.subplot(1,3,2)
plt.plot(vrijeme, v, linewidth = 1)

a = [-(10/0.1)*0.3*np.sin(np.sqrt(10/0.1)*i + np.arctan(0.3*np.sqrt(10/0.1)/0)) for i in vrijeme]
plt.subplot(1,3,3)
